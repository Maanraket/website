...
var img, c, blendModes, blendModeIterator, frameSize, resizeWidth, resizeHeight, maskPosWidth, maskPosHeight, webcamMode, capture, maskImage;
/*
TODO:
...
function setup() {
  ...
  blendModeIterator = 0;
  iterateBlendMode();
  console.log('hallo'); //frame gets divided by 'frameSize' to determine size of next frame
...
function redrawFrameSizeParams() {
  var _frameSize = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : frameSize;
  ...
  resizeHeight = height / frameSize; //maskPosWidth and maskPosHeight are used to calculate the position of the mask
...
function mouseWheel(event) {
  ...
  redrawFrameSizeParams(); //uncomment to block page scrolling

  return false;
}

function setRandomBackground() {
  img = loadImage('https://picsum.photos/' + width + '/' + height, function (_img) {
...
function windowResized() {
  ...
  if (!webcamMode) setRandomBackground();
}
